...
{
    [TestClass]
    public class CyrillicZamanalifTester : GenericTranslitCommandTester<CyrillicZamanalif>
    {
        public CyrillicZamanalifTester()
        {
            testPairs.Add("сәлам", "sälâm");
            testPairs.Add("зыян", "zían");
            testPairs.Add("ЗЫЯН", "ZÍAN");
            testPairs.Add("Щи ашы", "Şi aşı");
            testPairs.Add("щи Ашы", "şi Aşı");
            testPairs.Add("ЩИ АШЫ", "Şİ AŞI");
            testPairs.Add("Ия", "İä");
            testPairs.Add("\u04d8г\u04d9р д\u04d9...", "Ägär dä...");
            testPairs.Add("КАРЫЙБЫЗ", "QARÍBIZ");
            ...
            testPairs.Add("пакь хыяллар", "pak xíallar");
            ...
            testPairs.Add("Камалгали абзый!", "Kamalğali abzí!");
        ...
        [TestMethod]
        public void RunCyrillicZamanalifTest()
        {
            base.TestTranslit();
        }
    }
